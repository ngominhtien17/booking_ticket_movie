	...
	<div class="my-container">
		<aside>
			...
			<div class="my-sidebar">
				<div class="top">
					<div class="logo">
						<div style="width: 50px; height: 50px; border-radius: 10px; background-color: #695cfe; color: #f6f5ff; font-weight: 600; display: flex; justify-content: center; align-items: center; font-size: 1.4rem">K</div>
						<h2><span>K25 CINEMA</span></h2>
					</div>
				...
				<div class=" top">
					...
					<div class="profile d-md-flex align-items-center">
						<div class="info d-flex align-items-center">
							<span style="color: var(--color-dark)">Chào,</span> <b><?php if (!empty($_SESSION['user']))
								echo json_decode($_SESSION['user'])->name ?></b>
						</div>
