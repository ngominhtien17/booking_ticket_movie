<div class="dangchieu" id="showing">
	...
	<iv class="w-100 d-flex justify-content-between align-items-center flex-wrap">
		...
		<div class="search-box d-flex h-100 align-items-center">
  			<form class="form-inline">
    			<input class="form-control mr-sm-2" id="search-input" type="search" placeholder="Nhập tên phim..." aria-label="Search">
  			</form>
			  <button id="search-icon" class="btn button-type-film-showing active" type="submit">Tìm kiếm</button>
		</div>
	</div>
	<div class="row-phim">
		<?php
